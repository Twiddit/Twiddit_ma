                    ...
                    <Button small center color="default" style={styles.twidditButton}>
                        <Block row>
                            <Icon
                                ...
                                family="ArgonExtra"
                            />
                            <Text style={styles.twidditInteractions}> {item.comments}</Text>
                        </Block>
                    </Button>
                </Block>
                <Block flex center>
                    <Button small center color="default" style={styles.twidditButton}>
                        <Block row>
                            <Icon
                                ...
                                family="ArgonExtra"
                            />
                            <Text style={styles.twidditInteractions}> {item.retwiddits}</Text>
                        </Block>
                    </Button>
                </Block>
                <Block flex right>
                    <Button small center color="default" style={styles.twidditButton}>
                        <Block row>
                            <Icon
                                ...
                                family="ArgonExtra"
                            />
                            <Text style={styles.twidditInteractions}> {item.likes}</Text>
                        </Block>
                    </Button>
                </Block>
            </Block>
